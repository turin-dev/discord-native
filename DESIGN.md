...
| Right panel | 240px | guild members, search, pinned messages, DM relationships |
...
- guild와 DM header의 pin action은 240px 고정 메시지 panel을 연다. card 선택은 해당 message 주변 대화로 이동하고, 권한이 있으면 panel에서 해제할 수 있다.
